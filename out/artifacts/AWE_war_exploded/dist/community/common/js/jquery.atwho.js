...
(function (root, factory) {
    ...
    EditableController = (function (_super) {
        ...
        EditableController.prototype._movingEvent = function (e) {
            var _ref;
            return e && (e.type === 'click' || ((_ref = e.which) === KEY_CODE.RIGHT || _ref === KEY_CODE.LEFT || _ref === KEY_CODE.UP || _ref === KEY_CODE.DOWN));
        };
        ...
        EditableController.prototype.catchQuery = function (e) {
            var $inserted, $query, index, inserted, lastNode, matched, offset, query, range, rect;
        ...
        EditableController.prototype.insert = function (content, $li) {
            ...
            if (range = this._getRange()) {
                ...
                _range.setEndAfter(this.query.el[0]);
                _range.collapse(false);
                _range.insertNode(suffixNode = this.app.document.createTextNode(suffix));
                if ($.browser.msie || $.browser.mozilla && $.browser.version == 11) {
                    editor.focus(true);
                }
                this.$inputor.focus();
                this._setRange('after', suffixNode, _range);
                this.$inputor.focus();
            }
    ...
    View = (function () {
        function View(context) {
            this.context = context;
            this.$el = $("<div class='atwho-view'><label>选择最近@的人或者直接输入</label><ul class='atwho-view-ul'></ul></div>");
            this.timeoutID = null;
    ...
    DEFAULT_CALLBACKS = {
        ...
        matcher: function (flag, subtext, should_startWithSpace) {
            ...
            regexp = new RegExp("" + flag + "([A-Za-z" + _a + "-" + _y + "0-9_\.\+\-]*[^\\x00-\\xff]*)$", 'gi'); //中英文混输
