...
<div class="g-doc">
    <div class="g-search g-w1200 f-cb">
        <a class="g-logo" href=""><img src="${pageContext.request.contextPath }/dist/organ/images/logo.jpg"></a>
<!--
...
-->
    ...
    <div class="g-hd">
      ...
      <li ><a href="../AWE社区/03用户学社主页/学社主页1-机构主页 - 主页.html">学社总汇</a></li>
...
<!--                <p class="g-tt">AWE头条</p>-->
                <ul class="m-son-nav f-fl">
                   <li style="width: 80px;font-size: 14px;background: url(tmp/images/li_bg1.png)"><a href="">机构</a></li>  <!-- class="son-act"-->
					<li class="m-son-nav_active"><a href="学社主页1-机构主页 - 主页.html">	<span class="second_nav_top font_white">主页</span><span class="second_nav_bottom font_white">HOME</span></a></li>
       ...
       <span class="second_nav_bottom">COURCES</span>
          ...
          <li><a href="学社主页1-机构主页 - 老师.html"><span class="second_nav_top">老师(5)</span><span class="second_nav_bottom">TEACHERS</span></a></li>
               <li><a href="../AWE社区/03用户学社主页/学社主页1-机构主页 - 关于我们.html"><span class="second_nav_top">关于我们</span><span class="second_nav_bottom">ABOUT US</span></a></li>
...
他，小雨，非常完美
                ...
                <div class="m-btn f-cb" style="margin: 10px;">
                    <a href="../AWE社区/04学社管理/机构管理/机构管理 - 资料管理.html" class="m-btn-new" style="margin-left: -10px;">学社管理</a>
    ...
    padding-top: 25px;">咨询群QQ：12345006</span> 
            ...
            <div style="margin: 15px 0px;    padding: 0px 10px;">
             <a href="javascript:void(0)" class="m-btn-qd" style="background: #d6d4d3;margin-left: -10px;">前一步</a>
                    <a href="javascript:void(0)" class="m-btn-qd" style="float:right;background: #313342;margin-right: -10px;">后一步</a> 
				  </div>
			</div>
