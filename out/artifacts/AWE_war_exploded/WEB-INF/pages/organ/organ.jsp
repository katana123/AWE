...
-->
    ...
    <div class="g-banner">
        ...
        <ul class="m-nav f-cb g-w1200">
           <li>&nbsp;</li>
           <li class="g-act_second_active"><a href="index.html">机构页面</a></li>
...
<!--                <p class="g-tt">AWE头条</p>-->
                <ul class="m-son-nav f-fl">
                   <li style="width: 80px;font-size: 14px;background: url(tmp/images/li_bg1.png)"><a href="">机构</a></li>  <!-- class="son-act"-->
					<li class="m-son-nav_active"><a href="">	<span class="second_nav_top font_white">主页</span><span class="second_nav_bottom font_white">HOME</span></a></li>
					<li><div><a href="">
       ...
       <span class="second_nav_bottom">COURCES</span>
          ...
          <li><a href=""><span class="second_nav_top">资源(12)</span><span class="second_nav_bottom">  RESOURCES</span></a></li>
          <li><a href=""><span class="second_nav_top">老师(5)</span><span class="second_nav_bottom">TEACHERS</span></a></li>
               <li><a href=""><span class="second_nav_top">关于我们</span><span class="second_nav_bottom">ABOUT US</span></a></li>
...
<!--                        <dt class="m-news-list2-title"><a href="">2016年度中国现代远程教育十大新闻发布</a></dt>-->
                        ...
                        <div class="m-news-content">
                            ...
                            <dd>只为培养好学，拒绝平庸</dd>
							<dd><img class="m-user-img" src="tmp/images/list.jpg" width="30" height="30" style="padding-right: 10px;">DIXON    | 报名数：2888    <font style="color: #67b846;padding-left: 10px;font-size: 16px;">免费</font></dd>
            ...
            <div class="m-news-left m-news2-left">
               ...
               <div class="m-btn f-cb">
                        ...
                        <div style="width: 48%;float:left;text-align: center;">
							...
							<div class="mag_desc" style="width: 100%;height:36px;    line-height: 36px;"><span class="orange">已认证</span></div>
...
他，小雨，非常完美
                ...
                <div class="m-btn f-cb" style="margin-top: 10px;">
                   <a href="../04学社管理/机构管理/机构管理 - 资料管理.html" class="m-btn-new">学社管理</a>
					<span style="font-size: 11px;
    vertical-align: bottom;
    display: flex;
    padding-top: 25px;">咨询群QQ：12345006655</span> 
                </div>
