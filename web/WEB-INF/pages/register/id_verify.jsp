    ...
    color: #444446;">
                ...
                <div class="ui-form-item">
                    ...
                    <div class="checkcode-warp">
                        <input name="J_Phone_Checkcode" id="J_Phone_Checkcode" class="ui-input ui-input-checkcode-new ui-input-checkcode-over " type="text" maxlength="6" placeholder="6位数字" data-widget-cid="widget-1" data-explain="">
