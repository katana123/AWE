...
<!DOCTYPE html>
<html lang="en-US" class="hb-loaded"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<div id="content">
    <div class="content-layout">
        <div class="maincenter">
            ...
            -->
                        <img src="${pageContext.request.contextPath }/dist/register/img/1.png" width="50px"/> <span class="ui-step-text">验证身份</span> </div>
                </li>
            ...
            -->
                        <img src="${pageContext.request.contextPath }/dist/register/img/2.png" width="50px"/> <span class="ui-step-text" style="left: -70px;">修改安全邮箱</span> </div>
                </li>
            ...
            -->
                        <img src="${pageContext.request.contextPath }/dist/register/img/3.png" width="50px"/> <span class="ui-step-text">完成</span> </div>
                </li>
            </ol>
            <div class="maincenter-box">
                ...
                <form:form class="ui-form" id="J_Form" action="${pageContext.request.contextPath }/bound_email/${ccuser.cuid}" method="post" data-widget-cid="widget-1" modelAttribute="ccuser">
                    ...
                    <div class="ui-form-item">
                        ...
                        <input class="ui-input" type="text" maxlength="128" id="J_Email" value="" data-explain="" autocomplete="off" data-widget-cid="widget-2"/>
                        <div class="ui-form-explain"> </div></div>
                    <div class="ui-form-item ui-tiptext-success">
                        <button id="J_GetCode" class="ui-button ui-button-mwhite" type="button" data-widget-cid="widget-2">获取邮件校验码</button>
                        <%--<button class="ui-button ui-button-mdisable" id="J_GetCode" type="button" data-widget-cid="widget-5" disabled="">(30秒后)重新获取验证码</button>--%>
                        <div class="ui-form-explain" id="explain_text" style="display: none;"><i class="ui-tiptext-icon iconfont"></i>校验码已发送到你的邮箱，15分钟内输入有效，请勿泄露于他人</div>
                    </div>
                    <div class="ui-form-item">
                        <label class="ui-label"> 验证码: </label>
                        <input name="_fm-h-_0-c" id="J_Checkcode" class="ui-input ui-input-checkcode" type="text" maxlength="6" placeholder=" 6位数字 " value="" data-explain="" data-widget-cid="widget-3">
                    </div>
                    <div class="ui-form-item">
