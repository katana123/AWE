...
<div class="g-bd">
    <div class="g-mn  g-w1200 f-cb ">
        <div class="m-toutiao f-cb">
            ...
            <ul class="m-son-nav f-fl">
                ...
                <li class="m-son-nav_active"><a href="学社主页2-学社帖子 - 学社公告.html"><span class="second_nav_top font_white">学社公告</span><span
                        class="second_nav_bottom font_white">NOTICE </span></a></li>
    ...
    padding-right: 30px;">
                <ul>
                    ...
                    <li class="clearfix"><a rel="nofollow" class="topic_icon" href="" target="_blank"
                                            title="DDDDDouble"> <img class="topic_list_img_user" src="images/user2.jpg">
                    </a>
                        <div class="topic_content">
                            <div class="topic_title clearfix"><span class="topic_times">1天前</span> <a
                                    href="/topic/1711635071052/" class="ellipsis_text" target="_blank"
                    ...
                    <li class="clearfix"><a rel="nofollow" class="topic_icon" href="" target="_blank"
                                            title="DDDDDouble"> <img class="topic_list_img_user" src="images/user3.jpg">
                    </a>
                        <div class="topic_content">
                            <div class="topic_title clearfix"><span class="topic_times">1天前</span> <a
                                    href="/topic/1711635071052/" class="ellipsis_text" target="_blank"
