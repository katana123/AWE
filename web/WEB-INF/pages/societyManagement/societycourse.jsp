...
<div class="m-news-left m-news2-left">
    ...
    <div class="m-btn f-cb blue_border" style="height: 64px;line-height: 34px;">
        管理员：小李飞刀，Victoria,Dixon,我是谁，我爱他，小雨，非常完美
    </div>
    <div class="m-btn f-cb" style="margin: 10px;">
        <a href="../04学社管理/机构管理/机构管理 - 资料管理.html" class="m-btn-new" style="margin-left: -10px;">学社管理</a>
...
<jsp:include page="sofooter.jsp"></jsp:include>