...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/function.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/rest.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/my_community_activity.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/common.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/font-awesome.min.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/index.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/default.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/dist/communityFun/css/study_together.css"/>
    <script src="${pageContext.request.contextPath }/dist/communityFun/libs/jquery.min.js" type="text/javascript"
            charset="utf-8"></script>
    <script src="${pageContext.request.contextPath }/dist/communityFun/libs/jquery.SuperSlide.2.1.1.js"
...
<div class="g-doc">
    <div class="g-search g-w1200 f-cb">
        <a class="g-logo" href=""><img src="${pageContext.request.contextPath }/dist/communityFun/images/logo.jpg"></a>
        <!--
            ...
            <div class="bd">
                <ul>
                    <li><a href="" target=""><img
                            src="${pageContext.request.contextPath }/dist/communityFun/tmp/images/banner.png"></a></li>
                    <li><a href="" target=""><img
                            src="${pageContext.request.contextPath }/dist/communityFun/tmp/images/banner.png"></a></li>
                    <li><a href="" target=""><img
                            src="${pageContext.request.contextPath }/dist/communityFun/tmp/images/banner.png"></a></li>
