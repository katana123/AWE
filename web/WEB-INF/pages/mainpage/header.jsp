...
<div class="g-doc">
    <div class="g-search g-w1200 f-cb">
        <a class="g-logo" href="index"><img src="${pageContext.request.contextPath }/dist/mainpage/images/logo.jpg"></a>
            ...
            <div class="bd">
                <ul>
                    <li><a href="" target=""><img
                            src="${pageContext.request.contextPath }/dist/mainpage/tmp/images/banner.jpg"></a></li>
                    <li><a href="" target=""><img
                            src="${pageContext.request.contextPath }/dist/mainpage/tmp/images/banner.jpg"></a></li>
                    <li><a href="" target=""><img
                            src="${pageContext.request.contextPath }/dist/mainpage/tmp/images/banner.jpg"></a></li>
