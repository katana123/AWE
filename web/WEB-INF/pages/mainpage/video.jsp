...
<div class="m-product-list g-w1200">
    <div class="m-toutiao f-cb">
        ...
        <div class="m-btn f-cb f-fr"><a href="javascript:void(0)" class="m-btn-new">发布课程</a> <a
                href="javascript:void(0)" class="m-btn-qd">签到</a></div>
    </div>
    <div class="m-cp-list">
        <div class="m-list"><img src="${pageContext.request.contextPath }/dist/mainpage/tmp/images/porduct1.jpg"
            ...
            <div class="m-user f-cb"><img class="m-user-img"
                                          src="${pageContext.request.contextPath }/dist/mainpage/tmp/images/list.jpg"
                                          width="30" height="30">
                <p>owe教育</p>
            </div>
        </div>
        ...
        <div class="m-list"><img src="${pageContext.request.contextPath }/dist/mainpage/tmp/images/porduct.jpg"
                                 width="250" height="180"/>
            <p class="m-list-title">GRE 托福 雅思考试指导</p>
            <div class="m-price f-cb">
                <p class="f-fl m-price-color">免费</p>
...
<div class="m-product-list g-w1200">
    <div class="pagination" style=" margin-bottom: 30px;width: 100%;
    margin-top:50px;">
        <ul style="
