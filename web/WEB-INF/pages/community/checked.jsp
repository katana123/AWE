...
<div class="wrapper" style="overflow: hidden;">
    ...
    -->
                <img src="images/2.png" width="50px"> <span class="ui-step-text" style="left: -70px;">学社审核</span> </div>
            </li>
                    ...
                    <div class="create-form-item clearfix">
                        ...
                        <div class="create-form-con fl">
                              <div style="width: 100%;height:150px;background: #fff;color: #000;padding: 40px">
                                  ...
                                  <p  style="line-height: 20px;;padding-top: 30px;">为了营造绿色的网络环境，让我们一起携手合作，打造出一个优秀的学习平台，相互学习；共同进步！所谓梦想，是永不停息的疯狂，可怕的是，比你优秀的人比你还要努力。</p>
                                  <div style="float: left;padding-top: 30px;">
                                      <span style="float: left">&gt;&gt;仅差一步之遥</span>
                                      <a href="complete.jsp" id="formSubmit" class="btn btn-m btn-blue" style="float: left;   margin:10px; margin-top: -10px;">进入下一步</a>
...
<!--                                    <input type="checkbox">-->
                    ...
                    <div class="create-form-item clearfix">
                        ...
                        <div class="create-form-con fl">
                            <input placeholder="请填写公司或者教师名称，最多15个汉字，创建后名称不可修改" type="text" id="leagueName" class="width3" name="leagueName" value="">
                    ...
                    <div class="create-form-item clearfix" style="margin-top:0px">
                        ...
                        <div class="create-form-con fl">
                            ...
                            <div style="width: 200px;float:left"> <input type="radio" name="d_type" checked style="margin-bottom: 10px"/>我的营业执照<br> <img src="images/add.jpg"/></div>
                    ...
                    <div class="create-form-item clearfix">
                        ...
                        <div class="create-form-con fl">
                            <input placeholder="请输入身份证号码" type="text" id="leagueName" class="width3" name="leagueName" value="">
                            <input id="hid_IsRepeatName" type="hidden" value="0">
                        </div>
                    </div>
                    <div class="create-form-item clearfix">
