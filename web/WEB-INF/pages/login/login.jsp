        ...
        $(function () {
            $("#uname_pwd_login").validate({
                ...
                errorPlacement: function (error, element) {
                    ...
                    error.css({display: 'block', opacity: '0.8', top: -15});
                },
            ...
            $("#phone_login").validate({
                ...
                ignore: [],
                rules: {
                    tele: {required: true, mobile: true},
                    telcode: {required: true},
                },
                messages: {
                    tele: {required: "请输入电话号码"},
                    telcode: {required: "请输入手机验证码"},
                },
                //提交表单后，（第一个）未通过验证的表单获得焦点
                focusInvalid: true,
                //当未通过验证的元素获得焦点时，移除错误提示
            ...
            $("#get_tel_code").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath }/ajaxValidatePhone",
                    data: {phone: phone},
                    success: function (result) {
                        alert(1);
                    }
    ...
    <div class="right_div">
       ...
       border: 10px solid #fff;">
            ...
            <div class="qrcode-wrapper hidden">
                ...
                <div class="scan-login3"><a class="regist" href="../注册/注册.htm">免费注册</a></div>
        ...
        background-position: 0px -2px !important;" onfocus="hideu()"/>
                                <p id="nouser" class="error_tip">用户不存在</p>
                            </div>
        ...
        background-position: 0px -2px !important;" onfocus="hidep()"/>
                                <p id="falsepwd" class="error_tip">密码错误</p>
                            </div>
                    ...
                    <div class="mod_box eb_mod_box" data-isshow="0">
                        <form:form id="phone_login"
                                   action="${pageContext.request.contextPath }/loginSccuess" method="post"
                                   modelAttribute="ccuser">
                            <div class="ui-sign-item ui-name-item clearfix mb">
                                <input type="text" maxlength="32" class="ui-input short_text" name="tele"
                                       data-type="mobile" id="phone"
                                       placeholder="手机号码"
...
<script src="${pageContext.request.contextPath }/dist/login/js/jquery-1.8.3.min.js"></script>
