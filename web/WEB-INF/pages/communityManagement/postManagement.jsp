    ...
    <div class="wrapper">
        <div class="container pt20">
            <div class="container-title">
                ...
                <p style="border-bottom: 2px solid #28c2f5;width: 200px;">RECYCLE MANAGEMENT</p>
            </div>
            ...
            <div class="container member-manage">
                ...
                <div class="form-li">
                    <dl class="m-select" id="m_monthType">
                        ...
                        <dd style="display: none;">
                            ...
                            <a val="1" href="javascript:;">全部分类</a><a class="selected" val="全部"
                                                                      href="javascript:;">全部</a><a val="201707"
                                                                                                   href="javascript:;">201707</a><a
                                val="201706" href="javascript:">201706</a></dd>
                    </dl>

                    <div class="form-c mem-search" style="float: left">
                        <input type="text" placeholder="搜索本学社话题" maxlength="20" value="" id="txt_key">
                        <input id="hid_LeagueID" type="hidden" value="10118">
                        <a href="javascript:" class="btn-search"><i></i>搜索</a>
                    </div>
                    <div class="fr grey" style="float: left;text-indent: 1em;">
                        注：不包含学社活动帖
                    </div>
                </div>
                <div class="form-li">
              <span class="check_box">
                    ...
                    <div class="action_btns">
                        ...
                        <a id="blackListManageBTN1" href="javascript:" class="btn">移动分类</a>
                        <a id="blackListManageBTN2" href="javascript:" class="btn">批量删除</a>
                    </div>
                    <!--
                ...
                <div class="user_list">
                    <ul>
                        <li class="menu">
                            ...
                            <span class="month_post" data-value="1">发帖时间</span>
                            <span class="month_reply" data-value="3">分类</span>
                       ...
                       <span class="check_box">
                            ...
                            <a rel="nofollow" href="http://bulo.awe.com/72310219/" target="_blank">
                                ...
                                <!--                            <div class="other_info clearfix "> <span class="icons praise_num" title="点赞数"><i></i>0</span> <span class="icons reply_num" title="回帖数"><i></i>8</span> <span class="icons read_num" title="阅读数"><i></i>20</span>  </div>-->
                            </a>
                            <span class="member_nickName">xx</span>
                            <span class="month_post">2017-05-02</span>

                            <span class="month_check">学习</span>
                    ...
                    <i class="icon_down"></i>
                        ...
                        <span class="check_box">
                            ...
                            <span class="month_check">英语</span>
                    ...
                    <i class="icon_down"></i>
                        ...
                        <li class="article_mall icons " style="margin-left: 20px;"><a href="机构管理.html" title="机构管理">
