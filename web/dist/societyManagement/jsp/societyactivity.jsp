        ...
        <div class="g-mn  g-w1200 f-cb ">
            <div class="m-toutiao f-cb">
                ...
                <ul class="m-son-nav f-fl">
                    ...
                    <li class="m-son-nav_active"><a href="学社主页2-学社帖子 - 学社活动.html"><span
                            class="second_nav_top font_white">活动帖子(5)</span><span class="second_nav_bottom font_white">EVENT</span></a>
                    </li>
                        ...
                        <li class="clearfix"><a rel="nofollow" class="topic_icon" href="" target="_blank"
                            ...
                            <div class="topic_content">
                                ...
                                <div class="other_info clearfix "><span class="icons praise_num"
                                        ...
                                        class="icons read_num" title="阅读数"><i></i>170</span>
                                    <p class="effective_date">有效日期：20170601-20170608</p>
                                    <span class="topic_from">最后回复：<font style="color:#eda769">席琳和荣耀</font>　9小时前</span>
                                    　|　<a href="/mag/165506201865" target="_blank"><span
                                            class="grey location">积玉桥</span></a> <span
                                            class="grey total_num">128人</span>
                                </div>
                            </div>
                        </li>
                        <li class="clearfix"><a rel="nofollow" class="topic_icon" href="" target="_blank"
